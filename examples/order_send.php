...
$order = OrderRequest::create()
    ->setService(Service::from(1)) // Replace with a valid service ID from getServiceStructure()
    ->setSenderAddress(new Address(
        'Firma Sp. z o.o.',   // name
        'Jan Kowalski',       // contactPerson
    ...
    ->setNotification(
        (new NotificationRequest())
            ->setNew(true, false, true)   // receiverEmail, receiverSms, senderEmail
            ->setSent(true)               // receiverEmail
            ->setDelivered(true)          // receiverEmail
    )
...
try {
    ...
    $pickupHours = $client->getPickupHours('00-001');
